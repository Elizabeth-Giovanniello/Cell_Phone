...
#As a developer, I want the CellPhone class to have class instance variables to keep track of the CellPhone’s model, phone number, 
# contacts (dictionary), messages (list) and whether the cell phone is on vibrate mode or not.
